<%-- 
    Document   : profile
    Created on : 15-Dec-2023, 9:59:15 pm
    Author     : Manish
--%>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark primary-background">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#" data-toggle="modal" data-target="#profile-Modal"><span class="fa fa-address-book-o" ></span> Edit Profile</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="row mt-4">
                    <div class="col-md-4 ">
                        ...
                        <div class="list-group">
                            <a href="#" onclick="getPosts(0,<%= user.getId()%>,this)" class="c-link list-group-item list-group-item-action active" aria-current="true">
                                All Posts
                            </a>
